...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout() {
    ...
    juce::NormalisableRange<float> lowFreqRange(20.f, 20000.f, 1.f);
    lowFreqRange.setSkewForCentre(300.f);

    juce::NormalisableRange<float> peakFreqRange(20.f, 20000.f, 1.f);
